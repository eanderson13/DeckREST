...
/**
 * Test class for {@link InPlaceShuffler}.
 * 
...
public class InPlaceShufflerTest {
	...
	/**
	 * Test method for {@link main.InPlaceShuffler#shuffle(java.util.ArrayList)}.
	 */
	@Test
	public final void testShuffle() {
		Deck deck = new Deck("Test Deck", new InPlaceShuffler());
